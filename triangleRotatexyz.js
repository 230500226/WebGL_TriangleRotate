...
function mainFunction(){
    ...
    void main() {
        ...
        vec3 rotatedPosition = vec3(
            ...
            (vertexPosition.y * cosRx + vertexPosition.z * sinRx) * cosRz - vertexPosition.x * sinRz,
            (vertexPosition.z * cosRx - vertexPosition.y * sinRx) * cosRz + vertexPosition.x * sinRz
        );

        gl_Position = vec4(uPosition + rotatedPosition.xy, 0.0, 1.0);
    }`;
